...
from ConfLearning.models.rl_simple_choice import RescorlaChoiceMono, RescorlaChoiceDual, RescorlaChoiceMonoDeval, RescorlaChoiceDualDeval
...
if __name__ == '__main__':
    ...
    for m, models in enumerate(modellist):
        ...
        pd.concat([eval("parameter_m" + str(m)), eval("fit_m" + str(m))], axis=1).to_pickle(f"../results/fittingData/fittingData_{model_names[m]}_choice.pkl", protocol=4)
