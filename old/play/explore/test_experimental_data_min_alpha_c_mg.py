...
from ConfLearning.models.rl_simple_min_alpha_c import RescorlaConf, RescorlaConfGen, RescorlaConfBase, RescorlaConfBaseGen, RescorlaConfZero, RescorlaConfZeroGen, RescorlaConfBaseZero, RescorlaConfBaseZeroGen
...
if __name__ == '__main__':
    ...
    for m, models in enumerate(modellist):
        ...
        pd.concat([eval("parameter_m" + str(m)), eval("fit_m" + str(m))], axis=1).to_pickle(f"../results/fittingData_control/fittingData_{model_names[m]}_min_alpha_c.pkl", protocol=4)
