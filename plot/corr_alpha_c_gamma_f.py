...
for i, m in enumerate(models):
    ...
    axes[col].scatter(fittingData.ALPHA_C, fittingData.GAMMA, s=8, c='g', marker='o')
    axes[col].set_title(model_name[i])
    axes[col].set_xlabel('alpha_c')
    axes[0].set_ylabel('gamma_f')
...
fig.savefig('../figures/param_corr/corr_alpha_c_gamma_f.png', bbox_inches='tight')
plt.close()
