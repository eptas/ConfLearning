...
labels_conf = ['[-]', '[-]$^\mathrm{deval}$', '[conf+spec]', '[conf+unspec]', '[conf+spec]$^\mathrm{deval}$', '[conf+unspec]$^\mathrm{deval}$']
labels_choice = ['[choice]', '[choice]$^\mathrm{deval}$']
...
savefig(f"../figures/fitting/AIC_mg.png")
# plt.close()
