...
from ConfLearning.plot.util.plot_corr_alpha_gamma_winning import plot_corr_alpha_gamma
from ConfLearning.plot.util.histo_params_winning import plot_histo
...
plt.subplots_adjust(left=0.05, right=0.95, top=0.93, bottom=0.1, hspace=0.4, wspace=0.23)
ax7.set_position(Bbox(ax7.get_position()+ np.array([[0.13, 0], [-0.13, 0]])))
# savefig(f'../figures/model_params.png', pad_inches=0.01)
savefig(f'../figures/Figure6.tif', pad_inches=0.01, format='tif', dpi=600, pil_kwargs={"compression": "tiff_lzw"})
plt.show()