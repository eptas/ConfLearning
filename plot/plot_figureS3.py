...
# savefig(f'../figures/compare_unspec_spec_choice_ext.png', pad_inches=0.01)
savefig(f'../figures/FigureS3.tif', format='tif', dpi=600, pil_kwargs={"compression": "tiff_lzw"}, pad_inches=0.01)
plt.show()