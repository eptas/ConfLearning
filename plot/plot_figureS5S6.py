...
# savefig(f"../figures/model_recovery_{'fit_gen' if 'fit_gen' in path else 'gen_fit'}.png")
savefig(f"../figures/FigureS{'5' if 'fit_gen' in path else '6'}.tif", format='tif', dpi=600, pil_kwargs={"compression": "tiff_lzw"})
plt.show()