...
plot_BC(legend_value=False, legend_phase1=False, ylabel_as_title=True, reload=False, phaselabel_pos='top', title='Behavior: confidence')
plt.text(-0.11, 1.04, 'A', transform=plt.gca().transAxes, color=(0, 0, 0), fontsize=17)

ax2 = fig.add_subplot(gs[0, 5:10])
plot_MC(legend_value=False, legend_phase1=False, ylabel_as_title=True, reload=False, winning_model='MonoUnspec', phaselabel_pos='top', title='ConfUnspec: confidence', plot_mean=False)
...
plot_MC(legend_value=False, legend_phase1=False, ylabel_as_title=True, markersize_value=6, reload=False, winning_model='MonoSpec', phaselabel_pos='top', title='ConfSpec: confidence', plot_mean=False)
...
savefig(f'../figures/model/model_confidence.png', pad_inches=0.01)
plt.show()